...
class BBMNETScraper:
    ...
    @staticmethod
    def converter_para_sgl(edital_bbmnet: dict) -> dict:
        """
        ...
        hash_unico = hashlib.md5(hash_str.encode()).hexdigest()
        ...
        # Se não tem UF no endereço, tentar pegar do edital
...
def captar_editais_bbmnet(
    ...
    for uf in ufs:
        try:
            ...
            editais_sgl = [
                BBMNETScraper.converter_para_sgl(e)
